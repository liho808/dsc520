...
setwd("C:/Users/paul_/OneDrive/Documents/dsc520")
...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + ggtitle("Height vs. Earnings") + xlab("Height(Inches)") + ylab("Earnings(Dollars)")
